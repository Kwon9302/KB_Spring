...
public class RestPostControllerV2 {
    ...
    @GetMapping(value="/test",produces = "test/plain;charset=UTF-8")
    public ResponseEntity<String> test(){
        return ResponseEntity.status(HttpStatus.ACCEPTED).body("요청을 처리할 수 없습니다");
    }
...
//        model.addAttribute("postList", updateContent);
    ...
    public ResponseEntity<String> deletePost(@PathVariable("id") Long id) {
        ...
        int a = postRepository.deleteById(id);
        if (a > 0) {
